...
from api.apiviews import ProductoList, ProductoDetalle, \
        CategoriaList,SubCategoriaList, \
        CategoriaDetalle, \
        SubCategoriaAdd, \
        ProductoViewSet, \
...
urlpatterns = [
        ...
        path('v1/categorias/', CategoriaList.as_view(), name='catgoria_save'),
        #path('v1/subcategorias/', SubCategoriaList.as_view(), name='subcatgoria_save')
        path('v1/categorias/<int:pk>',CategoriaDetalle.as_view(), name='categproa_detalle'),
